...
def test_calculate_blast_radius_low_impact(impact_analyzer, mock_dependency_analyzer):
    ...
    directly_affected = [
        {"id": "r1", "name": "R1", "type": "storage", "cloud_provider": "azure"}
    ]
...
def test_calculate_blast_radius_high_impact(impact_analyzer, mock_dependency_analyzer):
    ...
    indirectly_affected = [
        {"id": "r3", "name": "R3", "type": "function_app", "cloud_provider": "azure", "distance": 2},
        {"id": "r4", "name": "R4", "type": "storage", "cloud_provider": "azure", "distance": 2},
    ]
    mock_dependency_analyzer.get_affected_resources.return_value = (directly_affected, indirectly_affected)
