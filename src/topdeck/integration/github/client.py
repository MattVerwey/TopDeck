...
from ...discovery.models import Repository, Deployment, Application
...
class GitHubIntegration:
    ...
    def _parse_repository(self, data: Dict[str, Any]) -> Optional[Repository]:
        """
    ...
    async def discover_applications(self) -> List[Application]:
        ...
        for repo in repositories:
            ...
            app = Application(
                ...
                name=repo.name,
                description=repo.description or f"Application from GitHub repository {repo.full_name}",
    ...
    def _infer_environment_from_repo(self, repo: Repository) -> Optional[str]:
        """
