...
class DiscoveryScheduler:
    ...
    def start(self) -> None:
        ...
        try:
            ...
            logger.info(
                f"Discovery scheduler started with {interval_hours}-hour interval"
            )
        ...
        try:
            ...
            if settings.enable_aws_discovery and self._has_aws_credentials():
                ...
                try:
                    ...
                    logger.info(
                        f"AWS discovery completed: {aws_result.resource_count} resources"
                    )
                except Exception as e:
            ...
            if settings.enable_gcp_discovery and self._has_gcp_credentials():
                ...
                try:
                    ...
                    logger.info(
                        f"GCP discovery completed: {gcp_result.resource_count} resources"
                    )
                except Exception as e:
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "interval_hours": settings.discovery_scan_interval // 3600,
            "enabled_providers": {
                "azure": settings.enable_azure_discovery
                and self._has_azure_credentials(),
