...
class FeatureExtractor:
    ...
    def get_feature_names(self) -> List[str]:
        ...
        return [
            # CPU features
            "cpu_mean", "cpu_max", "cpu_std", "cpu_trend",
            # Memory features
            "memory_mean", "memory_max", "memory_std", "memory_trend",
            # Error features
            "error_rate_mean", "error_rate_max", "error_spike_count",
            # Latency features
            "latency_p95_mean", "latency_p95_max", "latency_increasing",
            # History features
            "restart_count", "days_since_last_failure",
            # Graph features
            "dependency_count", "dependent_count", "dependency_depth",
            "is_central_node", "betweenness_centrality",
            "blast_radius", "is_spof",
            # Metadata features
            "is_database", "is_web_app", "is_load_balancer",
            "resource_age_days", "deployment_frequency", "config_change_frequency",
        ]
